...
- `AUTH_ADMIN_AUTHORIZE_URL`, `AUTH_ADMIN_CLIENT_ID`, `AUTH_ADMIN_CLIENT_SECRET`
- `AUTH_ADMIN_OIDC_CONFIGURATION_URL` (optional), `AUTH_ADMIN_TOKEN_URL`, `AUTH_ADMIN_USERINFO_URL`
- `AUTH_ADMIN_SCOPE`, `AUTH_ADMIN_REDIRECT_PATH` (path or full public callback URL)
- `AUTH_ADMIN_STUB_LOGIN_EMAIL` (dev-only fallback)
- `INVITE_TOKEN_TTL_HOURS`, `INVITE_STATE_TTL_MINUTES`, `INVITE_REQUIRE_EMAIL_MATCH`
- `AUTHENTIK_AUTHORIZE_URL`, `AUTHENTIK_CLIENT_ID`, `AUTHENTIK_CLIENT_SECRET`
- `AUTHENTIK_OIDC_CONFIGURATION_URL` (optional), `AUTHENTIK_TOKEN_URL`, `AUTHENTIK_USERINFO_URL`
- `AUTHENTIK_SCOPE`, `AUTHENTIK_REDIRECT_PATH` (path or full public callback URL)
